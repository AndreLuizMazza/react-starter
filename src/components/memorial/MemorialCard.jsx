...
function fmtDate(d) {
  ...
  try {
    ...
    const dt = new Date(d)
    // corrige parse de 'YYYY-MM-DD' como UTC em alguns browsers
...
export default function MemorialCard({ item }) {
  ...
  return (
    <div
      className="group relative overflow-hidden rounded-2xl bg-white/90 ring-1 ring-zinc-200/70 shadow-sm hover:shadow-md transition-all"
    >
      {/* faixa sutil no topo */}
      ...
      <div className="p-4 sm:p-5">
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0">
            ...
            {/* Datas */}
            <p className="text-xs sm:text-[13px] text-zinc-600 truncate">
              {nasc} – {fale}
            </p>
